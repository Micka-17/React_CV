                        ...
                        <div className="row">
                            ...
                            <div className="col-xs-6">
                                <div className="form-group">
                                    ...
                                    <input type="text" name="email" className="form-control email" id="email" value={toSend.fullName} onChange={handleChange} />
                                </div>
                            </div>
                            <div className="col-xs-6">
                                <div className="form-group">
                                    <label htmlFor="number">Numero de contact</label>
                                    <input type="number" name="number" className="form-control number" id="number" value={toSend.fullName} onChange={handleChange} />
                                </div>
                            </div>

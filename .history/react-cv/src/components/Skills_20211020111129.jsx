...
import { faHtml5, faUserCircle, faSignOutAlt, faHome, faSignOutAlt, faHome } from '@fortawesome/free-solid-svg-icons'
    ...
    return (
        ...
        <div class="container" data-aos="zoom-in">
            <div class="competences">
                <FontAwesomeIcon class="fab fa-html5 fa-5x" icon={faUserCircle, faSignOutAlt, faHome} />
                <h2>L'HTML</h2>

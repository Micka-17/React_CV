...
export default function Skills({page}) {
    ...
    return (
        <section id="sec-2">
            ...
            <p>Au sein d'une formation Openclassrooms j'ai acqui divers compétences, des plus basiques Html, Css, Javascript jusqu'à du React, Axios, API et bien d'autres! </p>
